...
variable.to.exclude = c("Income", "Region")
reduce <- FALSE
...
form.11 <- create.formula(outcome.name = outcome.name.awareness, input.names = input.names, input.patterns = NA, dat = snack.dat, interactions = interactions, force.main.effects = FALSE, reduce = TRUE, max.input.categories = max.input.categories, max.outcome.categories.to.search = max.outcome.categories.to.search, order.as = order.as, include.backtick = include.backtick, format.as = format.as, variable.to.exclude = variable.to.exclude)
