...
author: 'Authors: David Shilane, Caffrey Lee,Caffrey Lee, Anderson Nelson'
date: "`r Sys.Date()`"
vignette: >
...
*  max.input.categories This limits the maximum number of variables that will be employed in the formula. As default it is set at 20, but users can still change at his/her convinence.
