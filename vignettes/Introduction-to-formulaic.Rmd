...
Duplicates in input.names Example: if there is duplicates in input.name, for instance `duplicated.inputs`, create.formula will deduplicate them and take only one varialbe.
